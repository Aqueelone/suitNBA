...
import { sampleWithRequiredData } from '../player-in-team.test-samples';
...
describe('PlayerInTeam Management Component', () => {
  let comp: PlayerInTeamComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PlayerInTeamComponent],
      providers: [
        {
      ...
      .overrideTemplate(PlayerInTeamComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.playerInTeams?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to playerInTeamService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPlayerInTeamIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPlayerInTeamIdentifier).toHaveBeenCalledWith(entity);
