package org.forsstudio.nbatestsuit.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.forsstudio.nbatestsuit.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.forsstudio.nbatestsuit.security.DomainUserDetailsService", "createSpringSecurityUser");
